...
void display_settings() {
	draw_string("PC Connect", white);
	update_display(1);
	erase_buffer();

	draw_string("Learn Cmd", white);
	update_display(2);
	erase_buffer();

	draw_string("Rm Cmd", white);
	update_display(3);
	erase_buffer();

	draw_string("Add Device", white);
	update_display(4);
	erase_buffer();

	draw_string("Rm Device", white);
	update_display(5);
	erase_buffer();

	draw_string("Main Menu", white);
	update_display(9);
	erase_buffer();
}
